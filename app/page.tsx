...
import { projects, experience, skills, featuredTags, education, certifications } from '@/lib/data';
    ...
    <>
      ...
      <Section id="about" title="About">
        <p className="text-muted-foreground">
          I’m a developer focused on building performant, accessible, and delightful web apps.
          I enjoy solving complex problems with simple, elegant solutions and shipping real value.
        </p>
      </Section>
      ...
      <Section id="contact" title="Contact">
        <p className="text-muted-foreground">
          Want to collaborate or have a project in mind? Reach out and let’s talk.
        </p>
        <div className="mt-4">
          <a
